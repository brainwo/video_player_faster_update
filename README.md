A personal temporary fork to change hardcoded update interval from the base [`video_player`](https://github.com/flutter/packages) package. Will keep the fork until I have time to contribute to the upstream. Based on version 2.9.1 pub.dev distributed source code.

> [!IMPORTANT]
> Do not use this package, I will remove this package anytime from my GitHub without a warning or notices.
